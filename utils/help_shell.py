...
def get_help():
    tmpa = [
        ...
        '            Cast the value of VARS variable named name2 to a VARN value \n',
        '            which is the new value of the VARN variable named name1 \n',
        '        VARN name1 b!32 name2 \n',
        '            Cast the value of BIN32 variable named name2 to a VARN value \n',
        '            which is the new value of the VARN variable named name1 \n',
        '        VARN name1 b!16 name2 \n',
        '            Cast the value of BIN16 variable named name2 to a VARN value \n',
        '            which is the new value of the VARN variable named name1 \n',
        '        VARN name1 b!8 name2 \n',
        '            Cast the value of BIN8 variable named name2 to a VARN value \n',
        '            which is the new value of the VARN variable named name1 \n',
        '    \n',
        ...
        '                BIN8 name #n name2 \n',
        '                    Set the bvalue of the variable named name to the absolute value of the integer\n', 
        '                    cast of the value of the VARN type variable named name2 \n',
        '                \n',
        '                BIN16 name = bvalue\n',
        '                    Create a variable with a bvalue = bvalue or change the bvalue of an existant variable to bvalue\n',
        '                BIN16 name >\n',
